...
function gr(e) {
	...
	if (k(Qn, p), k($n, m), k(er, g), k(tr, _), k(Kn, y), k(qn, b), k(sr, E), k(or, ee), k(ar, te), k(nr, S), k(rr, w), k(ir, ne), d(D)) if (D.length) {
		let t = e.exposed ||= {};
		D.forEach((e) => {
...
var Xc = {
	...
	setup(e) {
		...
		H(() => [
			...
			t.repositoryId,
			t.state
		], () => void ee()), H(() => t.projectName, () => void T()), H(v, (e) => {
		...
		async function E() {
			...
			if (!(!e || u.value)) {
				...
				try {
					...
					a.value.some((e) => e.id === n.id) || (a.value = [n, ...a.value]), l.value = "", r.value = "ready", ee(), pn(te);
				} catch (e) {
		...
		return (t, a) => (q(), J("section", Xc, [
			...
			d.value ? (q(), J("p", ul, j(d.value), 1)) : Z("", !0),
			r.value === "loading" ? (q(), J("p", dl, "Loading issues…")) : r.value === "error" ? (q(), J("p", fl, j(i.value), 1)) : m.value.length === 0 ? (q(), J("p", pl, [
				...
				Y("span", yl, "#" + j(e.number), 1),
				Y("span", bl, [Y("span", xl, j(e.title), 1), Y("span", Sl, [
					...
					}, [a[7] ||= Y("span", { class: "project-glyph" }, "◇", -1), Li(" " + j(e.projectName), 1)], 8, Cl)) : Z("", !0),
					...
					e.authorRef ? (q(), J("span", {
						...
						Y("span", Tl, j(x(e.authorRef).glyph), 1),
				...
				Y("span", kl, j(S(e.createdAt)), 1)
			], 8, vl)], 42, _l))), 128))])),
			a[8] ||= Ri("<footer class=\"issues-foot\" data-v-44e68380><span data-v-44e68380><kbd data-v-44e68380>j</kbd> <kbd data-v-44e68380>k</kbd> navigate · <kbd data-v-44e68380>↵</kbd> open · <kbd data-v-44e68380>/</kbd> search · <kbd data-v-44e68380>c</kbd> create · <kbd data-v-44e68380>o</kbd> open <kbd data-v-44e68380>x</kbd> closed <kbd data-v-44e68380>a</kbd> all </span></footer>", 1)
		]));
	}
}), [["styles", [".issues-queue[data-v-44e68380]{font-family:var(--sans,system-ui);color:var(--ink,#111);gap:14px;display:grid}.issues-queue-head[data-v-44e68380]{gap:12px;display:grid}.head-row[data-v-44e68380]{justify-content:space-between;align-items:baseline;gap:12px;display:flex}.issues-queue-head h2[data-v-44e68380]{font-family:var(--display,system-ui);margin:0;font-size:22px;line-height:1}.issues-new[data-v-44e68380]{font-family:var(--mono,monospace);color:var(--ink-faint,#68645c);border:1.5px solid var(--ink,#111);padding:6px 12px;font-size:12px;text-decoration:none}.issues-controls[data-v-44e68380]{flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;display:flex}.issues-quick-add[data-v-44e68380]{border:1.5px solid var(--rule-light,#d8d1c4);background:var(--paper,#fffdf8);align-items:center;gap:8px;padding:6px 10px 6px 6px;transition:border-color .12s;display:flex}.issues-quick-add[data-v-44e68380]:focus-within{border-color:var(--ink,#111)}.issues-quick-add[data-busy=true][data-v-44e68380]{opacity:.85;border-style:dashed}.quick-add-glyph[data-v-44e68380]{width:22px;height:22px;font-family:var(--mono,monospace);color:var(--ink-faint,#68645c);border:1px solid;border-radius:2px;place-items:center;font-size:13px;display:inline-grid}.issues-quick-add input[data-v-44e68380]{min-width:0;color:inherit;font-family:var(--display,system-ui);background:0 0;border:0;outline:none;flex:1;padding:4px 0;font-size:15px}.issues-quick-add input[data-v-44e68380]::placeholder{color:var(--ink-fainter,#918b80);font-style:italic}.quick-add-status[data-v-44e68380]{font-family:var(--mono,monospace);color:var(--ink-faint,#68645c);font-size:11px}.quick-add-chip[data-v-44e68380]{font-family:var(--mono,monospace);letter-spacing:.02em;white-space:nowrap;border:1px solid;align-items:center;padding:1px 6px;font-size:10.5px;display:inline-flex}.quick-add-chip.tone-teal[data-v-44e68380]{color:var(--accent-teal,#087f6f)}.quick-add-chip.tone-yellow[data-v-44e68380]{color:var(--accent-yellow,#c89300)}.quick-add-hint[data-v-44e68380]{font-family:var(--mono,monospace);color:var(--ink-fainter,#918b80);white-space:nowrap;font-size:10.5px}.quick-add-hint kbd[data-v-44e68380]{font-family:var(--mono,monospace);border:1px solid;padding:0 4px;font-size:10px}.quick-add-error[data-v-44e68380]{font-family:var(--mono,monospace);color:var(--accent-err,#c9341c);margin:-6px 0 0;font-size:11px}.issues-filter-row[data-v-44e68380]{border:1.5px solid var(--ink,#111);flex-wrap:wrap;gap:4px;display:inline-flex}.issues-filter[data-v-44e68380]{color:inherit;cursor:pointer;font-family:var(--mono,monospace);background:0 0;border:0;align-items:center;gap:6px;padding:6px 10px;font-size:12px;display:inline-flex}.issues-filter[data-v-44e68380]:not(:last-child){border-right:1px solid var(--rule-light,#d8d1c4)}.issues-filter.active[data-v-44e68380]{background:var(--ink,#111);color:var(--paper,#fffdf8)}.issues-filter .count[data-v-44e68380]{color:var(--ink-faint,#68645c);font-variant-numeric:tabular-nums}.issues-filter.active .count[data-v-44e68380]{color:var(--paper-tint,#f2efe7)}.issues-filter kbd[data-v-44e68380]{font-family:var(--mono,monospace);opacity:.6;border:1px solid;padding:0 4px;font-size:10px}.issues-search[data-v-44e68380]{border:1.5px solid var(--ink,#111);flex:240px;align-items:center;gap:8px;min-width:240px;max-width:420px;padding:4px 10px;display:inline-flex}.issues-search input[data-v-44e68380]{color:inherit;font:inherit;background:0 0;border:0;outline:none;flex:1;min-width:0}.issues-search kbd[data-v-44e68380]{border:1px solid var(--ink,#111);font-family:var(--mono,monospace);color:var(--ink-faint,#68645c);padding:0 4px;font-size:10px}.muted[data-v-44e68380]{font-family:var(--mono,monospace);color:var(--ink-faint,#68645c);border-top:1.5px solid var(--rule-light,#d8d1c4);padding:18px 0;font-size:13px}.muted.error[data-v-44e68380]{color:var(--accent-err,#c9341c)}.issues-list[data-v-44e68380]{border-top:1.5px solid var(--ink,#111);margin:0;padding:0;list-style:none;display:grid}.issues-row[data-v-44e68380]{border-bottom:1px solid var(--rule-light,#d8d1c4)}.issues-row.focused[data-v-44e68380]{background:var(--paper-tint,#f2efe7)}.issues-row-link[data-v-44e68380]{color:inherit;grid-template-columns:56px 1fr auto;align-items:baseline;gap:14px;padding:12px 12px 12px 6px;text-decoration:none;display:grid}.issues-row-link[data-v-44e68380]:hover{background:var(--paper-tint,#f2efe7);text-decoration:none}.issues-row-number[data-v-44e68380]{font-family:var(--mono,monospace);color:var(--ink-faint,#68645c);text-align:right;font-variant-numeric:tabular-nums;font-size:12px}.issues-row-body[data-v-44e68380]{gap:4px;min-width:0;display:grid}.issues-row-title[data-v-44e68380]{font-family:var(--display,system-ui);text-overflow:ellipsis;white-space:nowrap;font-size:16px;font-weight:600;overflow:hidden}.issues-row-meta[data-v-44e68380]{font-family:var(--mono,monospace);color:var(--ink-faint,#68645c);flex-wrap:wrap;align-items:baseline;gap:10px;font-size:12px;display:flex}.issue-state[data-v-44e68380]{letter-spacing:.04em;text-transform:uppercase;border:1px solid;padding:0 6px;font-size:11px}.issue-state.issue-state-open[data-v-44e68380]{color:var(--accent-teal,#087f6f)}.issue-state.issue-state-closed[data-v-44e68380]{color:var(--accent-blue,#1d55a6)}.issue-project[data-v-44e68380]{font-family:var(--mono,monospace);color:var(--accent-blue,#1d55a6);border:1px solid;align-items:center;gap:4px;padding:0 6px;font-size:11px;display:inline-flex}.issue-project .project-glyph[data-v-44e68380]{font-size:10px}.issue-label[data-v-44e68380]{font-family:var(--mono,monospace);color:var(--accent-teal,#087f6f);letter-spacing:.02em;border:1px solid;padding:0 5px;font-size:10px}.issue-author[data-v-44e68380]{font-family:var(--mono,monospace);align-items:center;gap:5px;font-size:12px;display:inline-flex}.issue-author .author-glyph[data-v-44e68380]{width:14px;height:14px;color:var(--ink-faint,#68645c);border:1px solid;place-items:center;font-size:10px;font-weight:700;display:inline-grid}.issue-author[data-author-kind=agent][data-v-44e68380]{color:#6b3fa0}.issue-author[data-author-kind=credential][data-v-44e68380]{color:var(--accent-yellow,#c89300)}.issue-author[data-author-kind=bot][data-v-44e68380]{color:var(--accent-blue,#1d55a6)}.issue-author .author-badge[data-v-44e68380]{letter-spacing:.04em;text-transform:uppercase;border:1px solid;padding:0 4px;font-size:10px}.issues-row-age[data-v-44e68380]{font-family:var(--mono,monospace);color:var(--ink-faint,#68645c);white-space:nowrap;font-size:12px}.issues-foot[data-v-44e68380]{font-family:var(--mono,monospace);color:var(--ink-faint,#68645c);font-size:11px}.issues-foot kbd[data-v-44e68380]{font-family:var(--mono,monospace);border:1px solid;padding:0 4px;font-size:10px}"]], ["__scopeId", "data-v-44e68380"]]), jl = /* @__PURE__ */ new Map();
function Ml(e) {
	return [
		e.id,
		e.number,
