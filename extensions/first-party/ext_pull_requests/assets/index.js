...
var tu = {
	...
	setup(e) {
		...
		return (e, t) => (W(), G("section", Td, [
			...
			t[7] ||= Bi("<footer class=\"pulls-queue-foot\" data-v-74929813><span data-v-74929813><kbd data-v-74929813>j</kbd> <kbd data-v-74929813>k</kbd> navigate · <kbd data-v-74929813>↵</kbd> open · <kbd data-v-74929813>/</kbd> search · <kbd data-v-74929813>o</kbd> open <kbd data-v-74929813>d</kbd> draft <kbd data-v-74929813>m</kbd> merged <kbd data-v-74929813>c</kbd> closed <kbd data-v-74929813>a</kbd> all </span></footer>", 1)
		]));
	}
}), [["styles", [".pulls-queue[data-v-74929813]{font-family:var(--font-sans,system-ui);color:var(--fg,#fffffff0);gap:16px;display:grid}.pulls-queue-head[data-v-74929813]{gap:12px;display:grid}.pulls-queue-head h2[data-v-74929813]{font-family:var(--font-serif,system-ui);margin:0;font-size:22px;line-height:1}.pulls-queue-controls[data-v-74929813]{flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;display:flex}.pulls-filter-row[data-v-74929813]{border:.5px solid var(--fg,#fffffff0);flex-wrap:wrap;gap:4px;display:inline-flex}.pulls-filter[data-v-74929813]{color:inherit;cursor:pointer;font-family:var(--font-mono,monospace);background:0 0;border:0;align-items:center;gap:6px;padding:6px 10px;font-size:12px;display:inline-flex}.pulls-filter[data-v-74929813]:not(:last-child){border-right:.5px solid var(--line,#ffffff12)}.pulls-filter.active[data-v-74929813]{background:var(--fg,#fffffff0);color:var(--bg,#0a0b0e)}.pulls-filter .count[data-v-74929813]{color:var(--fg-3,#ffffff85);font-variant-numeric:tabular-nums}.pulls-filter.active .count[data-v-74929813]{color:var(--bg-2,#0e1014)}.pulls-filter kbd[data-v-74929813]{font-family:var(--font-mono,monospace);opacity:.6;border:.5px solid;padding:0 4px;font-size:10px}.pulls-search[data-v-74929813]{border:.5px solid var(--fg,#fffffff0);flex:240px;align-items:center;gap:8px;min-width:240px;max-width:420px;padding:4px 10px;display:inline-flex}.pulls-search input[data-v-74929813]{color:inherit;font:inherit;background:0 0;border:0;outline:none;flex:1;min-width:0}.pulls-search kbd[data-v-74929813]{border:.5px solid var(--fg,#fffffff0);font-family:var(--font-mono,monospace);color:var(--fg-3,#ffffff85);padding:0 4px;font-size:10px}.pulls-list[data-v-74929813]{border-top:.5px solid var(--fg,#fffffff0);margin:0;padding:0;list-style:none;display:grid}.pulls-row[data-v-74929813]{border-bottom:.5px solid var(--line,#ffffff12)}.pulls-row.focused[data-v-74929813]{background:var(--bg-2,#0e1014)}.pulls-row-link[data-v-74929813]{color:inherit;grid-template-columns:56px 1fr auto;align-items:baseline;gap:14px;padding:12px 12px 12px 6px;text-decoration:none;display:grid}.pulls-row-link[data-v-74929813]:hover{background:var(--bg-2,#0e1014);text-decoration:none}.pulls-row-number[data-v-74929813]{font-family:var(--font-mono,monospace);color:var(--fg-3,#ffffff85);text-align:right;font-variant-numeric:tabular-nums;font-size:12px}.pulls-row-body[data-v-74929813]{gap:4px;min-width:0;display:grid}.pulls-row-title[data-v-74929813]{font-family:var(--font-serif,system-ui);text-overflow:ellipsis;white-space:nowrap;font-size:16px;font-weight:600;overflow:hidden}.pulls-row-meta[data-v-74929813]{font-family:var(--font-mono,monospace);color:var(--fg-3,#ffffff85);flex-wrap:wrap;align-items:baseline;gap:10px;font-size:12px;display:flex}.pulls-state[data-v-74929813]{letter-spacing:.04em;text-transform:uppercase;border:.5px solid;padding:0 6px;font-size:11px}.pulls-state.pr-state-ready[data-v-74929813]{color:var(--accent-teal,#087f6f)}.pulls-state.pr-state-draft[data-v-74929813]{color:var(--fg-3,#ffffff85)}.pulls-state.pr-state-merged[data-v-74929813]{color:var(--accent-blue,#1d55a6)}.pulls-state.pr-state-closed[data-v-74929813]{color:var(--accent-err,#c9341c)}.pulls-branch[data-v-74929813]{font-family:var(--font-mono,monospace);color:var(--fg-2,#ffffffbd);font-size:12px}.pulls-branch span[data-v-74929813]{color:var(--fg-4,#ffffff57);padding:0 4px}.pulls-author[data-v-74929813]{color:inherit;font:inherit;font-family:var(--font-mono,monospace);cursor:pointer;background:0 0;border:1px dashed #0000;align-items:center;gap:5px;padding:0 5px;font-size:12px;display:inline-flex}.pulls-author[data-v-74929813]:hover{background:var(--bg-2,#0e1014);border-color:currentColor}.pulls-author.active[data-v-74929813]{background:var(--fg,#fffffff0);color:var(--bg,#0a0b0e);border-color:var(--fg,#fffffff0);border-style:solid}.pulls-author.active .author-glyph[data-v-74929813],.pulls-author.active .author-label[data-v-74929813]{color:inherit}.pulls-query-chips[data-v-74929813]{font-family:var(--font-mono,monospace);flex-wrap:wrap;align-items:center;gap:6px;margin-top:8px;font-size:11px;display:flex}.pulls-query-chips .query-chip[data-v-74929813]{letter-spacing:.02em;white-space:nowrap;border:.5px solid;align-items:center;padding:1px 7px;display:inline-flex}.pulls-query-chips .query-chip.tone-is[data-v-74929813]{color:var(--accent-teal,#087f6f)}.pulls-query-chips .query-chip.tone-author[data-v-74929813]{color:var(--fg,#fffffff0)}.pulls-query-chips .query-chip.tone-unknown[data-v-74929813]{color:var(--accent-warn,#c89300);border-style:dashed}.pulls-query-chips .query-chips-hint[data-v-74929813]{color:var(--fg-3,#ffffff85);letter-spacing:0;margin-left:4px}.pulls-query-chips .query-chips-hint code[data-v-74929813]{font-family:var(--font-mono,monospace);background:var(--bg-2,#0e1014);color:var(--fg-2,#ffffffbd);padding:0 4px;font-size:11px}.pulls-author-filter[data-v-74929813]{border:.5px solid var(--line,#ffffff12);background:var(--bg-2,#0e1014);font-family:var(--font-mono,monospace);align-items:center;gap:8px;margin-top:8px;padding:6px 10px;font-size:11px;display:inline-flex}.pulls-author-filter .prefix[data-v-74929813]{color:var(--fg-3,#ffffff85);letter-spacing:.04em;text-transform:lowercase}.pulls-author-filter .active-chip[data-v-74929813]{color:var(--fg,#fffffff0);border:.5px solid;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.pulls-author-filter .active-chip[data-author-kind=agent][data-v-74929813]{color:#6b3fa0}.pulls-author-filter .active-chip[data-author-kind=credential][data-v-74929813]{color:var(--accent-yellow,#c89300)}.pulls-author-filter .active-chip[data-author-kind=bot][data-v-74929813]{color:var(--accent-blue,#1d55a6)}.pulls-author-filter .active-chip[data-author-kind=team][data-v-74929813]{color:var(--accent-teal,#087f6f)}.pulls-author-filter .author-glyph[data-v-74929813]{place-items:center;width:12px;height:12px;font-size:9px;font-weight:700;display:inline-grid}.pulls-author-filter .clear[data-v-74929813]{color:var(--fg-3,#ffffff85);font-family:var(--font-mono,monospace);cursor:pointer;background:0 0;border:0;margin-left:auto;padding:0 2px;font-size:10.5px}.pulls-author-filter .clear[data-v-74929813]:hover{color:var(--fg,#fffffff0)}.pulls-author .author-glyph[data-v-74929813]{width:14px;height:14px;color:var(--fg-3,#ffffff85);border:.5px solid;place-items:center;font-size:10px;font-weight:700;display:inline-grid}.pulls-author[data-author-kind=agent] .author-glyph[data-v-74929813],.pulls-author[data-author-kind=agent] .author-label[data-v-74929813],.pulls-author[data-author-kind=agent] .author-badge[data-v-74929813]{color:#6b3fa0}.pulls-author[data-author-kind=credential] .author-glyph[data-v-74929813],.pulls-author[data-author-kind=credential] .author-label[data-v-74929813],.pulls-author[data-author-kind=credential] .author-badge[data-v-74929813]{color:var(--accent-yellow,#c89300)}.pulls-author[data-author-kind=bot] .author-glyph[data-v-74929813],.pulls-author[data-author-kind=bot] .author-label[data-v-74929813],.pulls-author[data-author-kind=bot] .author-badge[data-v-74929813]{color:var(--accent-blue,#1d55a6)}.pulls-author .author-badge[data-v-74929813]{letter-spacing:.04em;text-transform:uppercase;border:.5px solid;padding:0 4px;font-size:10px}.pulls-row-age[data-v-74929813]{font-family:var(--font-mono,monospace);color:var(--fg-3,#ffffff85);white-space:nowrap;font-size:12px}.pulls-empty[data-v-74929813],.pulls-error[data-v-74929813]{font-family:var(--font-mono,monospace);color:var(--fg-3,#ffffff85);border-top:.5px solid var(--line,#ffffff12);padding:18px 0;font-size:13px}.pulls-error[data-v-74929813]{color:var(--accent-err,#c9341c)}.pulls-queue-foot[data-v-74929813]{font-family:var(--font-mono,monospace);color:var(--fg-3,#ffffff85);font-size:11px}.pulls-queue-foot kbd[data-v-74929813]{font-family:var(--font-mono,monospace);border:.5px solid;padding:0 4px;font-size:10px}"]], ["__scopeId", "data-v-74929813"]]), ef = {
