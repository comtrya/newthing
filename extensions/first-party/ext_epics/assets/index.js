...
function si(e, i) {
	...
	let { insert: o, remove: s, patchProp: c, createElement: l, createText: u, createComment: d, setText: f, setElementText: p, parentNode: m, nextSibling: h, setScopeId: g = r, insertStaticContent: _ } = e, v = (e, t, n, r = null, i = null, a = null, o = void 0, s = null, c = !!t.dynamicChildren) => {
		...
		if (r && li(r, !1), (g = h.onVnodeBeforeUpdate) && Bi(g, r, n, e), f && Sn(n, e, r, "beforeUpdate"), r && li(r, !0), (m.innerHTML && h.innerHTML == null || m.textContent && h.textContent == null) && p(l, ""), d ? E(e.dynamicChildren, d, l, r, i, ci(n, a), o) : s || de(e, n, l, null, r, i, ci(n, a), o, !1), u > 0) {
		...
		let s = () => {
			if (e.isMounted) {
				...
				let u = t, d;
				li(e, !1), t ? (t.el = c.el, le(e, t, o)) : t = c, n && oe(n), (d = t.props && t.props.onVnodeBeforeUpdate) && Bi(d, s, t, c), li(e, !0);
				let f = Fr(e), p = e.subTree;
				e.subTree = f, v(p, f, m(p.el), be(p), e, i, a), t.el = f.el, u === null && Vr(e, f.el), r && G(r, i), (d = t.props && t.props.onVnodeUpdated) && G(() => Bi(d, s, t, c), i);
			} else {
				let o, { el: s, props: c } = t, { bm: l, m: u, parent: d, root: f, type: p } = e, m = Vn(t);
				if (li(e, !1), l && oe(l), !m && (o = c && c.onVnodeBeforeMount) && Bi(o, d, t), li(e, !0), s && we) {
					let t = () => {
...
function Pi(e = " ", t = 0) {
	return Z(vi, null, e, t);
}
function Fi(e = "", t = !1) {
	return t ? (J(), Ei(yi, null, e)) : Z(yi, null, e);
}
function Ii(e) {
	return e == null || typeof e == "boolean" ? Z(yi) : d(e) ? Z(K, null, e.slice()) : Di(e) ? Li(e) : Z(vi, null, String(e));
}
function Li(e) {
...
var $ = (e, t) => /* @__PURE__ */ Jt(e, t, Xi), sa = "3.5.34", ca = void 0, la = typeof window < "u" && window.trustedTypes;
if (la) try {
...
var To = ["data-state"], Eo = ["data-epic-id"], Do = { class: "epic-card-title" }, Oo = ["href"], ko = {
	...
	setup(e) {
		let t = e, n = /* @__PURE__ */ z("idle"), r = /* @__PURE__ */ z(null), i = /* @__PURE__ */ z(t.epics ?? []), a = $(() => t.epics ?? i.value), o = $(() => t.client ?? t.comtryaClient), s = $(() => `/x/epics/new?workspaceId=${t.workspaceId}`);
		Xn(c), Dn(() => [
			o.value,
			t.epics,
			t.workspaceId,
...
function bs(e) {
	...
	return s.setAttribute("role", "alert"), s.hidden = !0, r.append(i, a, o, s), r.addEventListener("submit", (t) => {
		t.preventDefault(), o.disabled = !0, s.hidden = !0, bo(void 0, {
			...
			window.location.assign(`/x/epics/${e.workspaceId}/${e.id}`);
		}).catch((e) => {
