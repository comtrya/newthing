...
- Add smoke validation that the cloned commit equals the commit shown in the rendered UI.
...
- Rust route tests for Git upload-pack auth/scope behavior.
- Rust route tests for receive-pack fail-closed or real push behavior.
