...
//! methods route typed inputs through `@comtrya/sdk-core`'s `invokeOp`,
//! which delegates to the loaded WASM component. The Rust dispatch table
//! is generated separately by `crates/server/build.rs`, not here.
